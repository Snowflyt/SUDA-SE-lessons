...
import jobPostingApi, { JobPostingCreationRequest } from '~~/apis/job_posting'

const posting = ref<JobPostingCreationRequest>({
  jobTitle: '',
  region: '',
  education: '',
  salaryFrom: 0,
...
const handleSubmit = () => {
  jobPostingApi.createJobPosting(posting.value)
  props.onClose()
}
</script>
