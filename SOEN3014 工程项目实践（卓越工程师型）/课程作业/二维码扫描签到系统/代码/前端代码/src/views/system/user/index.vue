<template>
  <div class="app-container">
      ...
      <el-row>
        <el-col :span="24">
          ...
          <el-button type="info" size="mini" icon="el-icon-s-operation" @click.native="openRole"
            v-permission="['/mgr/setRole']">角色分配</el-button>
        </el-col>
      </el-row>
    </div>
    ...
    <el-row>
      <el-col :span="4">
        <el-tree empty-text="暂无数据" :expand-on-click-node="false" :default-expand-all="true" :data="deptTree.data"
          :props="deptTree.defaultProps" @node-click="chooseDept" class="input-tree">
        </el-tree>
      </el-col>
      <el-col :span="20">
    ...
    <el-dialog title="角色分配" :visible.sync="roleDialog.visible" width="25%">
      <el-form>
        <el-row>
          <el-col :span="12">
            <el-tree :data="roleDialog.roles" ref="roleTree" show-checkbox node-key="id"
