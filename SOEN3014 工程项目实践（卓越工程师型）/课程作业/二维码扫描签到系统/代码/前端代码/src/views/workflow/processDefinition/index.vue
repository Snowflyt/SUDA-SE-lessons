      ...
      <el-row>
        <el-col :span="24">
          <el-button
            ...
            size="mini"
            icon="el-icon-plus"
            @click.native="onlineDrawingProcess"
            v-permission="['/workflow/process/definition/edit']"
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button
            ...
            size="mini"
            icon="el-icon-edit"
            @click.native="onlineModificationProcess(scope.row)"
          ...
          <el-button
            ...
            v-permission="['/workflow/process/definition/delete']"
