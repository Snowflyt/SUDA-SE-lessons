...
export default {
  async addProductModel (
    ...
    const res = await request.post<number, BaseResponse<number>>(
      '/addProductModel',
      {
        type: data.type,
  ...
  async deleteProductModel (id: number): Promise<BaseResponse<null>> {
    return await request.post<null, BaseResponse<null>>('/deleteProductModel', {
      productModelId: id
    })
  },
  ...
  async updateProductModel (
    ...
    const res = await request.post<null, BaseResponse<null>>(
      '/updateProductModel',
      {
